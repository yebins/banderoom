...
public class Sms {
	...
	public static String sendSms(String tel, String content) {
		...
		String accessKey = "ahqAiDsd05vhPkfQgjUG";                     						// 네이버 클라우드 플랫폼 회원에게 발급되는 개인 인증키
		String secretKey = "9R6qSjuxjdHJZHfWxfjNsBklKHxEvBSiz0xaNMuM";  										// 2차 인증을 위해 서비스마다 할당되는 service secret
		String serviceId = "ncp:sms:kr:284653437479:banderoom";        									// 프로젝트에 할당된 SMS 서비스 ID

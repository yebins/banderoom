...
<style>
	...
	.footer-name, .footer-name:hover, .footer-name:link, .footer-name:visited {
		font-weight: bold;
		color: #454b50;
	}
</style>
    ...
    <div class="h_row_center" style="width: 70%; height: 300px; display: flex;">
        ...
        <div style="position:relative; width: 860px;padding-top: 40px; height: 100%">
            ...
            <p style="margin-top: 16px;font-size: 12px;font-weight: normal;font-stretch: normal;font-style: normal;line-height: 1.67;letter-spacing: normal;color: #9ea4aa;">
                <a class="footer-name" href="https://github.com/Maazzii">김대환</a>
                <a class="footer-name" href="https://github.com/suhyuny">박수현</a>
                <a class="footer-name" href="https://github.com/nicknick3">김도현</a>
                <a class="footer-name" href="https://github.com/yebins">송예빈</a><br>
                전라북도 전주시 덕진구 백제대로 572 5층<br>
                사업자 등록번호 123-45-54321<br>
                통신판매업신고번호 2022-프로젝트-02020<br>
                (주)일조는 통신판매중개자로서, 통신판매의 당사자가 아니라는 사실을 고지하며 상품의 예약, 이용 및 환불 등과 관련한 의무와 책임은 각 판매자에게 있습니다.
            </p>

...
$(function() {
	...
	function unregUser(button) {
		...
		$.ajax({
			url:"withdraw.do",
			type:"post",
			data:"mIdx="+mIdx + "&memberType=host",
				...
				<div id="reglist">
					<table>
						...
						<tr>
							...
							<td>
								<button class="normal-button detail" onclick="showDetails(${hMember.mIdx})">상세</button>
							</td>
						</tr>
						</c:forEach>
					</table>
			...
			<div class="scroll-area">
				...
				<div class="inner-box basic-info">
					<div class="info-view">
						...
						<div id="details-brn" class="info-content">
						</div>
						<div class="small-title">
							이메일
						</div>

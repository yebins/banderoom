...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/css/space/myrsv.css">
...
<script src="<%=request.getContextPath() %>/js/space/myrsv.js"></script>
</head>
<body>
			...
			<c:forEach var="rsvVO" items="${currentRsv}">
				<div class="inner-box current-rsv" onclick="location.href='rsvdetails.do?resIdx=${rsvVO.resIdx}'">
					<div class="inner-box-content">
						<div class="space-thumb"><img src="<%=request.getContextPath() %>${rsvVO.thumb}"></div>
						<div class="rsv-info">
							...
							<div class="space-address-wrap">
								...
								<button class="normal-button map-button" onclick="showMap('${rsvVO.address}', '${rsvVO.name}')">&nbsp;지도<img src="<%=request.getContextPath() %>/images/map_pin.png" style="height: 20px; margin-left: 0px;"></button>			
							</div>

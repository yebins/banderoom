...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/css/space/myspace.css">
<script src="<%=request.getContextPath() %>/js/space/myspace.js"></script>
</head>
<body>
						...
						<div class="space-thumb">
							<c:choose>
								<c:when test="${vo.getThumb() != null}">
									<img src="<%=request.getContextPath() %>${vo.getThumb()}" width="100%">
								</c:when>
								<c:otherwise>
									썸네일 없음
								</c:otherwise>
